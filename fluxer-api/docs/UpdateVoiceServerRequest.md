...
**endpoint** | Option<**String**> | Client signal WebSocket endpoint URL for the voice server | [optional]
**api_key** | Option<**String**> | API key for authenticating with the voice server | [optional]
**api_secret** | Option<**String**> | API secret for authenticating with the voice server | [optional]
