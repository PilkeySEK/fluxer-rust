...
**report_type** | **ReportType** | Type of report (enum: message) | 
**category** | [**models::MessageReportCategoryEnum**](MessageReportCategoryEnum.md) |  | 
**message_link** | **String** | Link to the message being reported | 
**reported_user_tag** | Option<**String**> | Fluxer tag of the user who sent the message | [optional]
