...
pub struct CreateVoiceRegionResponse {
    #[serde(rename = "region")]
    pub region: Box<models::CreateVoiceRegionResponseRegion>,
}

impl CreateVoiceRegionResponse {
    #[must_use]
    pub fn new(region: models::CreateVoiceRegionResponseRegion) -> CreateVoiceRegionResponse {
